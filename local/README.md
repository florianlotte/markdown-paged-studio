...
| File                                                                       | Purpose                                                                                                                                                                                                                                                |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `config.json`                                                              | Any document setting: `title`, `subtitle`, `author`, `headerTitle`, `headerName`, `footerText`, `pageSize` (`A4`, `Letter`, `A5`), `marginTop`/`marginRight`/`marginBottom`/`marginLeft` (mm), `cover` (boolean). Copy `config.example.json` to start. |
